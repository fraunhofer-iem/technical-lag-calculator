...
import commands.createDependencyGraph.DependencyGraphService
...
import network.dependencies.model.Edge
import network.dependencies.model.Node
import network.dependencies.model.VersionKeyX
...
class LinkedDependencyNodeGraphServiceTest {
    ...
    fun transformDependencyGraph() = runTest {
        ...
        val transformedGraphs = dependencyGraphService.createProjectsFromGraphs(
            mapOf("npm" to graph)
        )
