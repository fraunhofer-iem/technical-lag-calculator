...
//        assert(result?.dependencyGraphDto?.packageManagerToScopes?.get("NPM")?.scopesToRoot?.get("dependencies")?.size  == 3 )
//        assert(result?.dependencyGraphDto?.packageManagerToScopes?.get("NPM")?.scopesToRoot?.get("dependencies")?.find { it.artifactId == "fontawesome-svg-core" }?.transitiveDependencies?.size == 1)
//        assert(result?.dependencyGraphDto?.packageManagerToScopes?.get("NPM")?.scopesToRoot?.get("devDependencies")?.size  == 3 )
//        assert(result?.dependencyGraphDto?.packageManagerToScopes?.get("NPM")?.scopesToRoot?.get("devDependencies")?.find { it.artifactId == "vite" }?.transitiveDependencies?.size  == 3 )
//
//    }
//
//}